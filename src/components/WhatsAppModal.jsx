      ...
      <DialogContent className="sm:max-w-[360px] p-0 overflow-hidden bg-white rounded-[24px] border-0 shadow-2xl">
        ...
        <div className="p-8 flex flex-col items-center text-center">
          ...
          <p className="text-[13px] text-gray-500 mb-8 leading-relaxed">
            Join our official WhatsApp group to get the latest news and welfare information about EonAssets Platform.
          </p>
          
          <Button 
            className="w-full bg-[#4082F6] hover:bg-blue-600 text-white rounded-[12px] h-[48px] text-[15px] font-bold shadow-md transition-all"
            onClick={() => {
              setIsOpen(false);
