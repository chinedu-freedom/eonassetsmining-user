      ...
      <div className="relative w-full">
        <input
          ...
          className={cn(
            ...
            "focus:border-amber-600 focus:outline-none focus:ring-1 focus:ring-amber-600 transition-all duration-150",
        ...
        {label && (
          <label
            ...
            className={cn(
              ...
              shouldFloatLabel
                ? [
                    "-top-2 text-xs font-medium text-amber-600",
                    "bg-white px-1",
                  ].join(' ')
                : [
                    "top-3 text-sm",
              ...
              "peer-focus:-top-2 peer-focus:text-xs peer-focus:text-amber-600 peer-focus:bg-white peer-focus:px-1"
            )}
          >
            {label}
          </label>
