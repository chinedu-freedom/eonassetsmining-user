      ...
      <div className="px-4 pt-4 pb-4 max-w-[480px] mx-auto w-full flex-1">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-red-400 bg-white rounded-[16px] border border-gray-100 shadow-sm">
            ...
            <Link href="/dashboard/news" className="mt-4 text-blue-500 text-xs font-bold underline">
              Return to News
            </Link>
          </div>
        ) : (
          <div className="bg-white rounded-[16px] p-[20px] border border-gray-100 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)]">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="text-[9px] font-bold px-2 py-0.5 rounded bg-blue-100 text-blue-600 flex items-center gap-1">
            ...
            {article.image ? (
              ...
              <div className="w-full h-[140px] bg-gradient-to-r from-blue-500 to-[#0f172a] rounded-xl mb-6 shadow-inner relative overflow-hidden flex items-center justify-center">
                ...
                <span className="text-white/50 text-[10px] font-bold tracking-widest uppercase z-10 flex items-center gap-2">
                  <ImageIcon size={14} /> EonAssets News
                </span>
              </div>
            )}
