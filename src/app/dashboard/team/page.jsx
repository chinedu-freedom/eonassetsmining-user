            ...
            <div className="bg-white rounded-[16px] border border-gray-100 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] p-5">
                  ...
                  <div 
                    ...
                    style={{ 
                      background: overview.total_team === 0 
                        ? '#f1f5f9' 
                        : `conic-gradient(#fecdd3 0% ${p1}%, #93c5fd ${p1}% ${p1+p2}%, #fde047 ${p1+p2}% 100%)` 
                    }}
                  >
              ...
              <div className="pt-4 border-t border-gray-100 flex justify-between items-center">
                ...
                <button
                  ...
                  className="text-[#3b82f6] text-[13px] hover:underline font-medium"
                >
                  View Team List
                </button>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 text-center">
                    <div>
                      <div className="text-[#1e3a8a] text-[16px] font-bold mb-1">{l1.valid_members}/{l1.total_members}</div>
                      <div className="text-gray-400 text-[10px]">Valid Members</div>
                    </div>
                    <div>
                      <div className="text-[#1e3a8a] text-[16px] font-bold mb-1">{l1.commission_rate}%</div>
                      <div className="text-gray-400 text-[10px]">Commission</div>
                    </div>
                    <div>
                      <div className="text-[#1e3a8a] text-[16px] font-bold mb-1">{Number(l1.total_earnings).toFixed(2)}</div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 text-center">
                    <div>
                      <div className="text-[#1e3a8a] text-[16px] font-bold mb-1">{l2.valid_members}/{l2.total_members}</div>
                      <div className="text-gray-400 text-[10px]">Valid Members</div>
                    </div>
                    <div>
                      <div className="text-[#1e3a8a] text-[16px] font-bold mb-1">{l2.commission_rate}%</div>
                      <div className="text-gray-400 text-[10px]">Commission</div>
                    </div>
                    <div>
                      <div className="text-[#1e3a8a] text-[16px] font-bold mb-1">{Number(l2.total_earnings).toFixed(2)}</div>
                      <div className="text-gray-400 text-[10px]">Total Earnings</div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 text-center">
                    <div>
                      <div className="text-[#1e3a8a] text-[16px] font-bold mb-1">{l3.valid_members}/{l3.total_members}</div>
                      <div className="text-gray-400 text-[10px]">Valid Members</div>
                    </div>
                    <div>
                      <div className="text-[#1e3a8a] text-[16px] font-bold mb-1">{l3.commission_rate}%</div>
                      <div className="text-gray-400 text-[10px]">Commission</div>
                    </div>
                    <div>
                      <div className="text-[#1e3a8a] text-[16px] font-bold mb-1">{Number(l3.total_earnings).toFixed(2)}</div>
                      <div className="text-gray-400 text-[10px]">Total Earnings</div>
                    </div>
                  </div>
                </div>
