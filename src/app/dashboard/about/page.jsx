  ...
  return (
    <div className="flex flex-col h-full bg-transparent overflow-y-auto [&::-webkit-scrollbar]:hidden">
      ...
      <div className="bg-[#131F37] px-4 py-3 flex items-center gap-2.5 sticky top-0 z-20 shadow-sm border-b border-white/5">
        ...
        <h1 className="text-white/90 text-[14px] font-bold">About Us</h1>
      </div>
      ...
      <div className="px-4 py-3 max-w-[480px] mx-auto w-full space-y-4">
            ...
            <>
              ...
              <div className="w-full h-[200px] bg-[#131F37] rounded-[16px] flex items-center justify-center border border-white/5 shadow-sm overflow-hidden relative group cursor-pointer">
                {mainImage?.image ? (
                  ...
                  <div className="absolute inset-0 bg-white/5 flex flex-col items-center justify-center gap-2 group-hover:bg-white/10 transition-colors">
                    <div className="w-8 h-8 bg-black/20 rounded-full flex items-center justify-center shadow-sm text-gray-400">
                      <ImageIcon size={14} />
                    </div>
                    <span className="text-[10px] font-medium text-gray-400">Journey Image Area</span>
                  </div>
                )}
              </div>
                  ...
                  {gridImages.map((img, idx) => (
                    <div key={img.id || idx} className="aspect-[4/3] bg-[#131F37] rounded-[12px] flex items-center justify-center border border-white/5 shadow-sm relative group cursor-pointer overflow-hidden">
                      {img.image ? (
                        ...
                        <div className="absolute inset-0 bg-white/5 flex flex-col items-center justify-center gap-1.5 group-hover:bg-white/10 transition-colors">
                          <div className="w-7 h-7 bg-black/20 rounded-full flex items-center justify-center shadow-sm text-gray-400">
                            <ImageIcon size={12} />
                          </div>
                          <span className="text-[9px] font-medium text-gray-400">Promo Image {idx + 1}</span>
                        </div>
                      )}
                    </div>
                  ))}
        ...
        {/* Why Choose siteName */}
        <div className="mt-6">
          <h3 className="text-white/90 font-bold text-[14px] text-center mb-3">Why Choose {siteName}?</h3>
            ...
            <div className="bg-[#131F37] rounded-[12px] p-3 border border-white/5 shadow-sm">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <h4 className="text-white/90 font-bold text-[12px] mb-1">Bank-Grade Protection</h4>
            ...
            <div className="bg-[#131F37] rounded-[12px] p-3 border border-white/5 shadow-sm">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <h4 className="text-white/90 font-bold text-[12px] mb-1">Smart Automation</h4>
                  <p className="text-gray-400 text-[10px] leading-relaxed">
            ...
            <div className="bg-[#131F37] rounded-[12px] p-3 border border-white/5 shadow-sm">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <h4 className="text-white/90 font-bold text-[12px] mb-1">Global Support Team</h4>
                  <p className="text-gray-400 text-[10px] leading-relaxed">
        ...
        <div className="mt-6 text-center">
          <h3 className="text-white/90 font-bold text-[16px]">Meet Our Team</h3>
          <p className="text-gray-400 font-medium text-[12px] mb-4">The experts behind your success</p>
            ...
            <div className="flex justify-between items-start px-2">
              {teamMembers.slice(0, 3).map((member, idx) => (
                <div key={member.id || idx} className="flex flex-col items-center flex-1">
                  ...
                  <div className="text-white/90 font-bold text-[12px] mb-0.5 whitespace-nowrap overflow-hidden text-ellipsis w-[90px] text-center">{member.name}</div>
                  <div className="text-gray-400 text-[10px] text-center w-[90px] leading-tight">{member.position}</div>
                </div>
              ))}
            </div>
          )}
